        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form method="get" action="{{ route('admin.specialTask.create') }}">
                    ...
                    <form method="post" action="{{ route('admin.specialTask.store') }}" id="common_form" data-action="{{ route('admin.specialTask.store') }}" class="form-horizontal">
                        <div class="form-group">
                            @if( count($errors) >0)
