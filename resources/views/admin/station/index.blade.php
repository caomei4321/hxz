                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        @foreach($stations as $station)
                            <tr class="gradeC">
                                ...
                                <td class="center">
                                    <button class="btn btn-primary btn-xs edit" data-id="{{ $station->id }}">编辑</button>
{{--                                    <a href=""><button type="button" class="btn btn-danger btn-xs">查看</button></a>--}}
                                    <button class="btn btn-warning btn-xs delete" data-id="{{ $station->id }}">删除</button>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
    ...
    <script>
        ...
        $('#add_department').click(function () {
            layer.open({
                ...
                fixed: false, //不固定
                maxmin: true,
                content: "{{ route('admin.station.create') }}"
            });
        });
        $('.edit').click(function () {
            var id = $(this).data('id');
