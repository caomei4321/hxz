        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <button class="btn btn-info " id="add_category" type="button"><i class="fa fa-paste"></i> 添加分类</button>
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        @foreach($userCategories as $category)
                            <tr class="gradeC">
                                ...
                                <td class="center">
                                    <button class="btn btn-primary btn-xs edit" data-id="{{ $category->id }}">编辑</button>
