            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    @if(empty($department->id))
                        <form method="POST" id="department_form" action="#" data-action="{{ route('admin.department.store') }}" class="form-horizontal">
                    @else
                        <form method="POST" id="department_form" action="#" data-action="{{ route('admin.department.update',$department->id) }}" class="form-horizontal">
                    ...
                    @endif
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input name="name" id="name" type="text" placeholder="" class="form-control" value="{{ old('name',$department->name) }}">
                            </div>
                        </div>
