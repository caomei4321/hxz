            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <tbody>
                        @foreach($dailyProcesses as $dailyProcess)
                            <tr class="gradeC">
                                <td>{{ $dailyProcess->id }}</td>
                                <td>{{ $dailyProcess->dailyTask->title }}</td>
                                <td>{{ $dailyProcess->user->name }}</td>
                                <td>{{ $dailyProcess->user->department->name }}</td>
                                <td>{{ $dailyProcess->created_at }}</td>
                                <td class="center">
                                    <a href="{{  route('admin.dailyProcess.show', ['dailyProcess' => $dailyProcess->id]) }}"><button type="button" class="btn btn-danger btn-xs" id="show" data-id="{{ $dailyProcess->id }}">查看</button></a>
                                    <button class="btn btn-warning btn-xs delete" data-id="{{ $dailyProcess->id }}">删除</button>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
                ...
                {{ $dailyProcesses->appends($filter)->links() }}
            </div>
        </div>
    </div>
@endsection
